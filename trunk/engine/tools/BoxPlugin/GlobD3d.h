...
struct VerNor
{
	...
	D3DXVECTOR3 p;
	D3DXVECTOR3 np;// The transformed position for the vertex.
};
...
struct VerSkinNCT
{
	VerSkinNCT(){ b1=b2=b3=0; memset( Index, 0, 4 ); diffuse=0xff000000; p = np = D3DXVECTOR3(0,0,0); tu=tv=tu1=tv1=tu2=tv2=0.0;}
...
struct VerNCT
{
	VerNCT(){ diffuse=0xff000000; p = np = D3DXVECTOR3(0,0,0); }
...
typedef WORD uint16;
typedef BYTE uint8;
typedef D3DXVECTOR2 CVector2f;

typedef int int32;

struct CVector3f : public D3DXVECTOR3
{
	CVector3f(){}
	CVector3f( float x, float y, float z ):D3DXVECTOR3( x, y, z ){}
	CVector3f( D3DXVECTOR3 v ):D3DXVECTOR3( v ){}
	void Normalize()
	{
...
public:
	...
	CTinyQuaternion( const D3DXQUATERNION& q )
	{
