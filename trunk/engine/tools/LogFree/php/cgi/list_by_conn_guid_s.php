...
function ViewLog()
{
	...
	$qs = "$server_count_info $server_from_info $server_where_info and slc.conn_guid = '$guid'";
	...
	$qs = "$server_select_info $server_from_info $server_where_info and slc.conn_guid = '$guid' order by happened_time desc limit $b, $e";
	$result = mysql_query($qs);
...
<!--
<?php
	printf("var url='list_by_conn_guid_s.php?guid=%s&';\n", $_GET["guid"]);
