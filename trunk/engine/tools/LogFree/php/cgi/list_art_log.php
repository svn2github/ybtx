...
<p>
      <ul>
         ...
         <li class="item current"><a href='list_art_log.php?page=1&order=1'>美术资源log</a></li>
...
function ViewLog()
{
	...
	$qs = "select count(distinct clc.error_code) from tbl_client_log_common clc, tbl_log_info li, tbl_guid_info gi where li.error_code = clc.error_code and gi.guid = clc.client_guid and li.error_type like binary '资源缺失%' and gi.is_special_client = 0";
...
<!--
<?php
	printf("var url='list_art_log.php?order=$order&';\n");
