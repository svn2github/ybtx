...
<p>
      <ul>
         ...
         <li class="item current"><a href='list_designer_log_c.php?order=1&page=1'>客户端配置表log</a></li>
...
function ViewLog()
{
	...
	$qs = "select count(distinct clc.error_code) from tbl_client_log_common clc, tbl_log_info li, tbl_guid_info gi where li.error_code = clc.error_code and gi.guid = clc.client_guid and li.error_type like binary '配置表出错%' and gi.is_special_client = 0";
...
<!--
<?php
	printf("var url='list_designer_log_c.php?order=$order&';\n");
