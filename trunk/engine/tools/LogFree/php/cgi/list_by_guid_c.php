...
function ViewLog()
{
	...
	$qs = "$client_count_info $client_from_info $client_where_info and clc.client_guid= '$guid'";
	...
	$qs = "$client_select_info $client_from_info $client_where_info and clc.client_guid = '$guid' $client_order_info limit $b, $e";
	$result = mysql_query($qs);
...
<!--
<?php
	printf("var url='list_by_guid_c.php?guid=%s&';\n", $_GET["guid"]);
