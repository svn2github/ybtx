...
function ViewLog()
{
	...
	$qs = "$client_count_info $client_from_info $client_where_info and clc.urs = '$user'";
	...
	$qs = "$client_select_info $client_from_info $client_where_info and clc.urs = '$user' $client_order_info limit $b, $e";
	$result = mysql_query($qs);
...
<!--
<?php
	printf("var url='list_by_user_c.php?user=%s&';\n", $_GET["user"]);
