...
class CEditModelConsoleProp 
	: public CModelConsoleProp
	,public CEditUnitPropHelp
{
public:
	CEditModelConsoleProp( uint32 ID, IEffectClassDesc* pEffectClassDesc );
...
protected:
	...
	virtual void			_GetListNames(vector<EString>& PieceList, vector<EString>& AniList, vector<EString>& SKList);
	virtual void			_GetListNames(EString* PieceList, EString* AniList, EString* SKList);
};