================================================================================
    MICROSOFT 基础类库： TextureEditor 项目概述
===============================================================================

应用程序向导已为您创建了此 TextureEditor 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 TextureEditor 应用程序的每个文件的内容摘要。

TextureEditor.vcproj
...
TextureEditor.h
    ...
    CTextureEditorApp 应用程序类。

TextureEditor.cpp
    这是包含应用程序
    类 CTextureEditorApp 的主应用程序源文件。
...
res\TextureEditor.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 TextureEditor.rc 中。

res\TextureEditor.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 TextureEditor.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

TextureEditorDoc.h、TextureEditorDoc.cpp - 文档
    这些文件包含 CTextureEditorDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CTextureEditorDoc::Serialize）。
TextureEditorView.h、TextureEditorView.cpp - 文档视图
    这些文件包含 CTextureEditorView 类。
    CTextureEditorView 对象用于查看 CTextureEditorDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 TextureEditor.pch 的预编译头文件 (PCH)
