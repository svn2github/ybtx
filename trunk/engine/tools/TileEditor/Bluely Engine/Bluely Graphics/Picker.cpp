...
void CPicker::SetLastSelected(sc::CTerrainMesh::CObject * p)
{
	m_pLastSelected = p;
}
...
//	
//	if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vNew) )
//	{
//		dwGrid = floor(vNew.x) + floor(vNew.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
...
//
//					// upright
//					dwGrid += sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
//					vecGridIndices.push_back(dwGrid);
//
//					// up
//					dwGrid -= 1;
...
//	{	
//		sc::CTerrainMesh::SGrid & grid = sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetGrid(*iter);
//	
//		//////////////////////////////////////////////////////////////////////////
//	
//		D3DXVECTOR3 v0 = sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetVertex(grid.dwVertexIndex[0]).vPosition;
//		D3DXVECTOR3 v1 = sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetVertex(grid.dwVertexIndex[1]).vPosition;
//		D3DXVECTOR3 v2 = sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetVertex(grid.dwVertexIndex[2]).vPosition;
//		D3DXVECTOR3 v3 = sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetVertex(grid.dwVertexIndex[3]).vPosition;
//	
//		float u,v,d;
//	
...
//////////////////////////////////////////////////////////////////////////
	...
	//DWORD dwGrid;
	//
	//if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecStart) )
	//{
	//	dwGrid = floor(vecStart.x) + floor(vecStart.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//	vecGridIndices.push_back(dwGrid);
	//}
	//
	//if ( vPos.z < vec2.z )
	...
	//			if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecUp) )
	//			{
	//				dwGrid = floor(vecUp.x) + floor(vecUp.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//				vecGridIndices.push_back(dwGrid);
	//			}
	//			
	//			// right
	...
	//			
	//			if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecRight) )
	//			{
	//				dwGrid = floor(vecRight.x) + floor(vecRight.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//				vecGridIndices.push_back(dwGrid);
	//			}
	...
	//			//if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecRightUp) )
	//			//{
	//			//	dwGrid = floor(vecRightUp.x) + floor(vecRightUp.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//			//	vecGridIndices.push_back(dwGrid);
	//			//}
	...
	//			//if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecRightDown) )
	//			//{
	//			//	dwGrid = floor(vecRightDown.x) + floor(vecRightDown	.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//			//	vecGridIndices.push_back(dwGrid);
	//			//}
	...
	//			//if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecDown) )
	//			//{
	//			//	dwGrid = floor(vecDown.x) + floor(vecDown.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//			//	vecGridIndices.push_back(dwGrid);
	//			//}
	...
	//			}
	//			
	//			if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecNew) )
	//			{
	//				dwGrid = floor(vecNew.x) + floor(vecNew.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//				vecGridIndices.push_back(dwGrid);
	//			}
	//		}
	//	}
	...
	//			
	//			if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vecLeft) )
	//			{
	//				dwGrid = floor(vecLeft.x) + floor(vecLeft.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//				vecGridIndices.push_back(dwGrid);
	//			}
...
int CPicker::GetPickPos(CTerrainMesh::CObject ** pp, D3DXVECTOR3 * pvHitPoint)
{
	...
	//			if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vNewAdded) )
	//			{
	//				dwGrid = floor(vNewAdded.x) + floor(vNewAdded.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
	//				m_vecGridIndices.push_back(dwGrid);
	//			}
	//		}
	//	}
	...
	if ( vStart.z < vEnd.z )
	{
		if ( 0.0f < tg )
		{
			for ( int i = 0; i < SEARCH_TOLERANCE; i++)
			{
				...
				{
					dwGrid = floor(vNew.x) + floor(vNew.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
					if ( sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(dwGrid) )
					{
						m_vecGridIndices.push_back(dwGrid);
					}
	...
	{	
		...
		if ( pp && !grid.vecObjects.empty() && *pp == NULL )
		{
			...
			{
				sc::CTerrainMesh::CObject * p = (*iter).ptr();
	...
	if ( vStart.z < vEnd.z )
	{
		if ( tg > 0.0f )
		{
			for ( int i = 0; i < dwSearchCnt; i++)
			{
				...
				if ( fNewAdded && sc::CTileEditApp::GetInstance()->GetTerrainMesh()->IsValid(vNewAdded) )
				{
					dwGrid = floor(vNewAdded.x) + floor(vNewAdded.z) * sc::CTileEditApp::GetInstance()->GetTerrainMesh()->GetWidth();
					vecGridIndices.push_back(dwGrid);
				}
