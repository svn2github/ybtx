...
public:
	...
	void SetBlockMask(std::vector<sc::CTileEditorModel::SBlockInfo> & vecBlock); 
	void SetBlockType(std::vector<sc::CTileEditorModel::SBlockInfo> & vecBlock);
//	void SetBlockLogicHeight(std::vector<sc::CTileEditorModel::SBlockInfo> & vecBlock); 
	
	void SetLogicHeight(std::vector<sc::CTileEditorModel::SLogicHeightInfo> & vecHeight); 
