...
void CTileEditorModel::Create(string strFileName, bool bSubUnit, float fLift, float fShiftX, float fShiftZ)
{
...
{	
	...
	if ( sc::CTileEditApp::GetInstance()->GetOperator()->GetSelectMode() )
	{
...
void CTileEditorModel::SetBlockType(std::vector<sc::CTileEditorModel::SBlockInfo> & vecBlock) 
{
...
//void CTileEditorModel::SetBlockLogicHeight(std::vector<sc::CTileEditorModel::SBlockInfo> & vecBlock) 
//{
//	for ( int i = 0; i < vecBlock.size(); ++i )
//	{
...
void CTileEditorModel::SetLogicHeight(std::vector<sc::CTileEditorModel::SLogicHeightInfo> & vecHeight) 
{
...
void CTileEditorModel::SetBlockMask(std::vector<sc::CTileEditorModel::SBlockInfo> & vecBlock) 
{
	for ( int i = 0; i < vecBlock.size(); ++i )
	{
