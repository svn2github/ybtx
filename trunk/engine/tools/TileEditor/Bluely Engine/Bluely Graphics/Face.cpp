...
void CFace::AddContainer(std::vector<sc::CTileEditorModel *> & vec, bool bSubUnit, CTileEditorModel::ECenter_Type eBlockType, int nXDelta, int nZDelta)
{
...
sc::CTileEditorModel * CFace::GetSelfPresentation(int n) 
{
...
void CFace::SetCenterType(sc::CTileEditorModel::ECenter_Type e)
{
	for_each(m_vecSelfPresentation.begin(),m_vecSelfPresentation.end(),
