...
class CTileEditorModel : public ISceneNode
{
public:
...
public:
	...
	void SetBlockMask(std::vector<CTileEditorModel::SBlockInfo> & vecBlock); 
	void SetBlockType(std::vector<CTileEditorModel::SBlockInfo> & vecBlock);
//	void SetBlockLogicHeight(std::vector<CTileEditorModel::SBlockInfo> & vecBlock); 
	
	void SetLogicHeight(std::vector<CTileEditorModel::SLogicHeightInfo> & vecHeight); 
...
//		int i = (n/m_nDepthDimInGrids)*m_nWidthDimInGrids + (n%m_nWidthDimInGrids);
	...
	CTileEditorModel(ISceneNode * pParent);
	...
	void Create(std::string strFileName, bool bSubUnit, float fLift, float fShiftX, float fShiftZ, int &BlockInfoNum, int &LogicHeightInfoNum);
	void Render();
