...
private:
	std::vector<CTileEditorModel *> m_vecSelfPresentation;
...
public:	
	...
	void AddContainer(std::vector<CTileEditorModel *> & vec,bool bSubUnit, CTileEditorModel::ECenter_Type eBlockType, int nXDelta, int nZDelta);
	CTileEditorModel * GetSelfPresentation(int n); 
