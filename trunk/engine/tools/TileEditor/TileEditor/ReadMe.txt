...
应用程序向导已为您创建了此 MapEditor 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 MapEditor 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 MapEditor.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
MapEditorDoc.h、MapEditorDoc.cpp - 文档
    这些文件包含 CMapEditorDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CMapEditorDoc::Serialize）。
MapEditorView.h、MapEditorView.cpp - 文档视图
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 MapEditor.pch 的预编译头文件 (PCH)
