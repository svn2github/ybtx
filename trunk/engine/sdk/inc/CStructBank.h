...
extern COMMON_API int32 g_bDebugStructBanks;
...
COMMON_API int32 sb_AllocateNewStructPage(StructBank *pBank, uint32 nAllocations);

// Initialize.. pass in the size of your structure and how much to cache.
COMMON_API void sb_Init(StructBank *pBank, uint32 structSize, uint32 cacheSize);
...
COMMON_API int32 sb_Init2(StructBank *pBank, uint32 structSize, uint32 cacheSize,
...
COMMON_API void sb_FreeAll(StructBank *pBank);


// Shutdown.
COMMON_API void sb_Term(StructBank *pBank);
COMMON_API void sb_Term2(StructBank *pBank, int32 bCheckObjects);

// Returns TRUE if the object is currently allocated.
// Only returns FALSE in debug mode..
COMMON_API bool sb_IsObjectAllocated(StructBank *pBank, void *pObj);
