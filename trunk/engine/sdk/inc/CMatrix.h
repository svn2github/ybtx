...
namespace sqr
{
	class CMatrix : public CMathMallocObject
	{
	public:
		static const CMatrix	UNIT_MATRIX;
	public:
		...
		*/
		...
		//! 赋值构造函数
		CMatrix(	float _f11, float _f12, float _f13, float _f14,
		...
		//!按行设置矩阵
		void SetWithRow(const CVector3f& r0,const CVector3f& r1,const CVector3f& r2,const CVector3f& r3);

		//!  求同一矩阵
		_MATH_INLINE_ void Identity();
		//! 求逆矩阵
		void		Invert();
		//! 求逆矩阵
		bool		InvertFast();
		...
		bool		operator != (const CMatrix& m2) const;
		// 矩阵和矢量相乘
		const CVector3f operator*( const CVector3f &b) const;
		//! 设置偏移矩阵
		...
		bool SetOrthoOffCenterLH(  float l,	float r, float b, float t,
			float zn, float zf );
		bool SetOrthoLH(  float w, float h, float zn, float zf );

		bool SetLookAtLH(const CVector3f& vEye,	const CVector3f& vAt, const CVector3f& vUp );
		...
		CVector3f&getColumn( int iCol ) const;
	...
	_MATH_INLINE_ CMatrix::CMatrix(	float _f11, float _f12, float _f13, float _f14,
		float _f21, float _f22, float _f23, float _f24,
		float _f31, float _f32, float _f33, float _f34,
		float _f41, float _f42, float _f43, float _f44 )
	...
	//! 拷贝构造函数
	_MATH_INLINE_ CMatrix::CMatrix(const CMatrix&	mat)
	{
	...
	*******************************************************************************/
	_MATH_INLINE_ CMatrix::CMatrix(float fPitch, float fYaw, float fRoll)
	{
	...
	*******************************************************************************/
	_MATH_INLINE_ CMatrix::CMatrix(const CVector3f& vDir, float fRads)
	{
	...
	*   \sa     SetView
	*******************************************************************************/
	_MATH_INLINE_ CMatrix::CMatrix(const CVector3f& vX, const CVector3f& vY,
		const CVector3f& vZ, const CVector3f& vOrg)
	{
	...
	*   \sa     SetView
	*******************************************************************************/
	_MATH_INLINE_ CMatrix::CMatrix(const CVector3f& vFrom, const CVector3f& vAt,
		const CVector3f& vUp)
	{
	...
	*   \return 无
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetWithRow(const CVector3f& r0,const CVector3f& r1,const CVector3f& r2)
	{
	...
	//!按行设置矩阵
	_MATH_INLINE_ void CMatrix::SetWithRow(const CVector3f& r0,const CVector3f& r1,const CVector3f& r2,const CVector3f& r3)
	{
		_11 = r0.x,_12 = r0.y,_13 = r0.z,_14 = 0;
		_21 = r1.x,_22 = r1.y,_23 = r1.z,_24 = 0;
		_31 = r2.x,_32 = r2.y,_33 = r2.z,_34 = 0;
		_41 = r3.x,_42 = r3.y,_43 = r3.z,_44 = 1;
	}
	...
	*   \return 无
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetWithColumn(const CVector3f& c0,const CVector3f& c1,const CVector3f& c2)
	{
	...
	*   \return void
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::Identity()
	{
	...
	*   \return void
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetTranslate( float tx, float ty, float tz )
	{
		Identity();
		_41 = tx;
		_42 = ty;
	...
	*   \return void
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetTranslate( const CVector3f& v )
	{
	...
	*   \return void
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetScale( float sx, float sy, float sz )
	{
		Identity( );
		_11 = sx;
		_22 = sy;
	...
	*   \return void
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetScale( const CVector3f& v )
	{
	...
	*******************************************************************************/
	/*
	_MATH_INLINE_ void CMatrix::SetTransform(const CCoord& crd, bool IsWorldToObj)
	{
	...
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetTransform( const CVector3f& vX, const CVector3f& vY,
		const CVector3f& vZ, const CVector3f& vOrg)
	{
		// Start building the matrix. The first three rows contains the basis
		// vectors used to rotate the view to point at the lookat point
	...
	*   \return bool
	*******************************************************************************/
	_MATH_INLINE_ bool CMatrix::SetProjection(float fFOV, float fAspect, float fNearPlane,
		float fFarPlane)
	{
		/* D3D SDK
		xScale     0          0               0
	...
	_MATH_INLINE_ bool CMatrix::SetOrthoLH(  float w, float h, float zn, float zf )
	{
		/* D3D SDK
		2/w  0    0           0
		0    2/h  0           0
	...
	_MATH_INLINE_ bool CMatrix::SetOrthoOffCenterLH(  float l,	float r, float b, float t,
		float zn, float zf )
	{
		/* D3D SDK
		2/(r-l)      0            0           0
	...
	_MATH_INLINE_ bool CMatrix::SetLookAtLH(const CVector3f& vEye,	const CVector3f& vAt, const CVector3f& vUp )
	{
		/* D3D SDK
		zaxis = normal(At - Eye)
		...
		*/
		CVector3f zaxis(vAt - vEye);
		zaxis.normalize();
		CVector3f xaxis(vUp.Cross(zaxis));
		xaxis.normalize();
	...
	*   \param  float fRads		旋转的弧度值
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetRotateX( float fRads )
	{
		Identity( );

		float c = CMath::Cos(fRads);
		float s = CMath::Sin( fRads );
	...
	*   \param  float fRads 旋转的弧度值
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetRotateY( float fRads )
	{
		Identity( );
	...
	*   \param  float fRads 旋转的弧度值
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetRotateZ( float fRads )
	{
		Identity( );
	...
	*   \param  float fRoll		相对于z轴旋转的弧度
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetRotation(float fPitch, float fYaw, float fRoll)
	{
		CMatrix	matTemp;
	...
	*   \return void
	*******************************************************************************/
	_MATH_INLINE_ void CMatrix::SetRotation( const CVector3f& vDir, float fRads )
	{
		float		fCos	= CMath::Cos( fRads );
		float		fSin	= CMath::Sin( fRads );
		CVector3f	v		= vDir;
		v.Normalize();
	...
	*******************************************************************************/
	inline void CMatrix::Invert()
	{
		...
		*/
		...
		if ( gIsZero( fScale - 1.0f ) || gIsZero( fScale ) )
		{
			_11 = InMat._11;
			_12 = InMat._21;
			_13 = InMat._31;
	...
	*******************************************************************************/
	...
	_MATH_INLINE_ void CMatrix::Transpose3x3()
	{
		for (int i = 0; i < 3; i++)
		{
			for (int j = i + 1; j < 3; j++)
	...
	_MATH_INLINE_ const CVector3f CMatrix::GetLoc() const
	{
		return CVector3f( _41, _42, _43 );
	}

	_MATH_INLINE_ CVector3f CMatrix::GetAxis( int axis ) const
	{
		return CVector3f
			(
			m[axis][0],
	...
	_MATH_INLINE_ CVector3f& CMatrix::getColumn( int iCol ) const
	{
		return *((CVector3f*)m[iCol]);
	}

	_MATH_INLINE_ const CVector3f CMatrix::operator*( const CVector3f& b) const
	{
		return CVector3f(
	...
	_MATH_INLINE_ bool CMatrix::operator == (const CMatrix& m2)  const
	{
		if( 
