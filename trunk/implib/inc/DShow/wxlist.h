...
#endif
{
    /* Making these classes inherit from CDSBaseObject does nothing
...
#ifdef DEBUG
    class CNode : public CDSBaseObject {
#else
    class CNode {
#endif
...
typedef CGenericList<CDSBaseObject> CDSBaseObjectList;
