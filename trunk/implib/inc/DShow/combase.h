...
b. Make a static CreateInstance function that takes an LPUNKNOWN, an HRESULT *
   ...
   In retail builds NAME(_x_) compiles to NULL, the base CDSBaseObject class
...
private:
    ...
    CDSBaseObject(const CDSBaseObject& objectSrc);          // no implementation
    void operator=(const CDSBaseObject& objectSrc);       // no implementation
...
public:
    ...
    CDSBaseObject(const TCHAR *pName);
#ifdef UNICODE
    CDSBaseObject(const char *pName);
#endif
    ~CDSBaseObject();
