CMessageShapeEffectSecondWnd =  class( SQRDialog )

function CMessageShapeEffectSecondWnd:Ctor()
	self:CreateFromRes("MessageShapeEffectSecondWnd",g_GameMain)
	self.m_RichText = self:GetDlgChild("RichText")
end

function CMessageShapeEffectSecondWnd:SetMsgInfo(MsgStr)
