gac_require "relation/tong/RobResourceWnd/ScoreInfoWndInc"

function CreateRobResScoreInfoWnd(parent)
	local Wnd = CRobResScoreInfoWnd:new()
...
--end
--
--function CRobResScoreInfoWnd:InitListWnd()
...
--function CRobResScoreInfoWnd:InsertItemList(ItemNum, ColNum, ColTitle)
--	local Item = self.m_InfoList:GetSubItem(ItemNum,ColNum)
--	Item:SetWndText(ColTitle)
--end
--
--function CRobResScoreInfoWnd:InitInfoWnd()
...
--
----经过时间
--function CRobResScoreInfoWnd:SetTime()
--	local CostTime = 0
--	local Item = self.m_InfoList:GetSubItem(0,1)
...
--		g_GameMain.m_FbActionScoreTick = nil
--	end
--	g_GameMain.m_FbActionScoreTick = RegisterTick( "RobResScoreInfoWndTick", Time, 1000)
--end
--
--function CRobResScoreInfoWnd:GetListGameTime(SecondNum)
--	local Hour = 0
--	local Min = 0
--	local Sec = 0
...
--function CRobResScoreInfoWnd:UpdateMemberInfo(KillNum,StillNum,CurrPoint,MostKillNum)
